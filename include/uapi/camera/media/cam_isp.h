...
#define CAM_ISP_VIRTUAL_RDI0_PATH 0x400
#define CAM_ISP_VIRTUAL_RDI1_PATH 0x800
#define CAM_ISP_VIRTUAL_RDI2_PATH 0x1000
#define CAM_ISP_VIRTUAL_RDI3_PATH 0x2000
#define CAM_ISP_VIRTUAL_RDI4_PATH 0x4000
 ...
 * @context_id                  : sensor context id to which this vc/dt belongs
 * @vc                          : input virtual channel number
 * @dt                          : input data type number
 ...
 * @sync_id                     : indicates sensors are in sync
 * @frame_freeze_count          : tolerable rate for consecutive frame freezes
 * @reserved                    : Reserved field for alignment
 */
