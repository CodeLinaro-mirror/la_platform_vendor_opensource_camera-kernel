	...
	uint32_t args_size)
{
	...
	CAM_DBG(CAM_ISP, "VFE:%u Acquire out_type:0x%x %d use_hw_ctxt:%s hw_ctx_id:0x%x",
		ver3_bus_priv->common_data.core_index,
		out_port_res_type, out_acquire_args->vfe_res_out_id,
