...
static struct ais_irq_register_set vfe780_bus_irq_reg[2] = {
		{
...
static struct ais_vfe_bus_ver2_hw_info vfe780_bus_hw_info = {
	...
	.bus_client_reg = {
		/* BUS Client 0 */
		{
			...
			.status1                  = 0x00002578,
			.cfg                      = 0x00002500,
			.header_addr              = 0x00002520,
			.header_cfg               = 0x00002528,
			.image_addr               = 0x00002504,
			.image_addr_offset        = 0x00002570,
			.buffer_width_cfg         = 0x0000250C,
			.buffer_height_cfg        = 0x0000250C,
			...
			.frame_inc                = 0x00002508,
			.burst_limit              = 0x0000251C,
			.ubwc_regs                = NULL,
		},
		/* BUS Client 1 */
		{
			...
			.status1                  = 0x00002678,
			.cfg                      = 0x00002600,
			.header_addr              = 0x00002620,
			.header_cfg               = 0x00002628,
			.image_addr               = 0x00002604,
			.image_addr_offset        = 0x00002608,
			.buffer_width_cfg         = 0x0000260C,
			.buffer_height_cfg        = 0x0000260C,
			...
			.frame_inc                = 0x00002608,
			.burst_limit              = 0x0000261C,
			.ubwc_regs                = NULL,
		},
		/* BUS Client 2 */
		{
			...
			.status1                  = 0x00002778,
			.cfg                      = 0x00002700,
			.header_addr              = 0x00002720,
			.header_cfg               = 0x00002728,
			.image_addr               = 0x00002704,
			.image_addr_offset        = 0x00002708,
			.buffer_width_cfg         = 0x0000270C,
			.buffer_height_cfg        = 0x0000270C,
			...
			.frame_inc                = 0x00002708,
			.burst_limit              = 0x0000271C,
			.ubwc_regs                = NULL,
		},
		/* BUS Client 3 */
		{
