...
static struct ais_irq_register_set vfe780_top_irq_reg_set[2] = {
	{
...
static struct ais_irq_controller_reg_info vfe780_top_irq_reg_info = {
	.num_registers = 2,
...
static struct ais_vfe_camif_ver2_reg vfe780_camif_reg = {
...
static struct ais_vfe_camif_reg_data vfe_780_camif_reg_data = {
...
static struct ais_vfe_camif_lite_ver2_reg vfe780_camif_lite_reg = {
...
static struct ais_vfe_camif_lite_ver2_reg_data vfe780_camif_lite_reg_data = {
...
static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe780_lens_reg = {
	.reset    = 0x0000001C,
	.cgc_ovd  = 0x0000002C,
	.enable   = 0x00000040,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe780_stats_reg = {
	.reset    = 0x00000020,
	.cgc_ovd  = 0x00000030,
	.enable   = 0x00000044,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe780_color_reg = {
	.reset    = 0x00000024,
	.cgc_ovd  = 0x00000034,
	.enable   = 0x00000048,
};

static struct ais_vfe_top_ver2_reg_offset_module_ctrl vfe780_zoom_reg = {
	.reset    = 0x00000028,
	.cgc_ovd  = 0x00000038,
	.enable   = 0x0000004C,
};
...
static struct ais_vfe_bus_ver2_stats_cfg_info vfe780_stats_info  = {
	.dmi_offset_info = {
...
static struct ais_vfe_top_ver2_reg_offset_common vfe780_top_common_reg = {
...
static struct ais_vfe_rdi_ver2_reg vfe780_rdi_reg = {
	.reg_update_cmd           = 0x000004AC,
};

static struct ais_vfe_rdi_reg_data  vfe_780_rdi_0_data = {
	.reg_update_cmd_data      = 0x2,
	.sof_irq_mask             = 0x8000000,
	.reg_update_irq_mask      = 0x20,
};

static struct ais_vfe_rdi_reg_data  vfe_780_rdi_1_data = {
	.reg_update_cmd_data      = 0x4,
	.sof_irq_mask             = 0x10000000,
	.reg_update_irq_mask      = 0x40,
};

static struct ais_vfe_rdi_reg_data  vfe_780_rdi_2_data = {
...
static struct ais_vfe_top_ver2_hw_info vfe780_top_hw_info = {
	...
	.camif_hw_info = {
		.common_reg     = &vfe780_top_common_reg,
		.camif_reg      = &vfe780_camif_reg,
		.reg_data       = &vfe_780_camif_reg_data,
		},
	.camif_lite_hw_info = {
		.common_reg     = &vfe780_top_common_reg,
		.camif_lite_reg = &vfe780_camif_lite_reg,
		.reg_data       = &vfe780_camif_lite_reg_data,
		},
	.rdi_hw_info = {
		.common_reg = &vfe780_top_common_reg,
		.rdi_reg    = &vfe780_rdi_reg,
		.reg_data = {
			&vfe_780_rdi_0_data,
			&vfe_780_rdi_1_data,
			&vfe_780_rdi_2_data,
...
static struct ais_irq_register_set vfe780_bus_irq_reg[3] = {
		{
...
static struct ais_vfe_bus_ver2_hw_info vfe780_bus_hw_info = {
	...
	.bus_client_reg = {
		...
		/* BUS Client 3 */
		{
			...
			.ubwc_regs                = &vfe780_ubwc_regs_client_3,
		},
		/* BUS Client 4 */
		{
			.status0                  = 0x00002600,
		...
		/* BUS Client 20 */
		{
			...
			.ubwc_regs                = &vfe780_ubwc_regs_client_20,
		},
		/* BUS Client 21 */
		{
			.status0                  = 0x00003700,
			...
			.ubwc_regs                = &vfe780_ubwc_regs_client_21,
		},
		/* BUS Client 22 */
		{
			.status0                  = 0x00003800,
	...
	.stats_data = &vfe780_stats_info,
};

static struct ais_vfe_hw_info ais_vfe780_hw_info = {
	.irq_reg_info                  = &vfe780_top_irq_reg_info,
