...
static struct ais_vfe_rdi_ver2_reg vfe78x_rdi_reg = {
	.reg_update_cmd           = 0x000004AC,
};

static struct ais_vfe_rdi_reg_data  vfe78x_rdi_0_data = {
	.reg_update_cmd_data      = 0x2,
	.sof_irq_mask             = 0x8000000,
	.reg_update_irq_mask      = 0x20,
};

static struct ais_vfe_rdi_reg_data  vfe78x_rdi_1_data = {
	.reg_update_cmd_data      = 0x4,
	.sof_irq_mask             = 0x10000000,
	.reg_update_irq_mask      = 0x40,
};

static struct ais_vfe_rdi_reg_data  vfe78x_rdi_2_data = {
	.reg_update_cmd_data      = 0x8,
	.sof_irq_mask             = 0x20000000,
	.reg_update_irq_mask      = 0x80,
};

static struct ais_vfe_rdi_reg_data  vfe78x_rdi_3_data = {
