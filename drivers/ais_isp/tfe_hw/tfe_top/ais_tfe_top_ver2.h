...
#ifndef _AIS_TFE_TOP_VER2_H_
#define _AIS_TFE_TOP_VER2_H_

#include "ais_tfe_camif_ver2.h"
#include "ais_tfe_camif_lite_ver2.h"
#include "ais_tfe_rdi.h"
#include "ais_tfe_fe_ver1.h"
...
struct ais_tfe_top_ver2_hw_info {
	...
	struct ais_tfe_rdi_ver2_hw_info             rdi_hw_info;
	...
	uint32_t top_irq_reset_mask[AIS_TOP_IRQ_NUM_MAX];
	uint32_t bus_reg_irq_mask[AIS_TOP_IRQ_NUM_MAX];
	uint32_t error_irq_mask[AIS_TOP_IRQ_NUM_MAX];
	uint32_t non_fatal_error_irq_mask[AIS_TOP_IRQ_NUM_MAX];
	uint32_t rdi_path_reset_val;
	uint32_t sof_irq_mask;
	uint32_t wr_bus_mask;
	uint32_t rdi_overflow_mask;
	uint32_t rdi_overflow_shift;
};

int ais_tfe_top_ver2_init(struct cam_hw_soc_info     *soc_info,
	struct cam_hw_intf                           *hw_intf,
	void                                         *top_hw_info,
	struct ais_vfe_top                          **vfe_top);

int ais_tfe_top_ver2_deinit(struct ais_vfe_top      **vfe_top);

#endif /* _AIS_TFE_TOP_VER2_H_ */
