...
#ifndef _AIS_TFE_SOC_H_
#define _AIS_TFE_SOC_H_

#include "cam_soc_util.h"
#include "ais_isp_hw.h"

#define AIS_TFE_DSP_CLK_NAME "tfe_dsp_clk"
 ...
 *
 * @is_tfe_lite:             Flag to indicate full vs lite TFE
 */
 ...
 *                           Non-zero: Failure
 */
int ais_tfe_enable_soc_resources(struct cam_hw_soc_info *soc_info,
		unsigned long max_clk_rate);

/*
 * ais_tfe_disable_soc_resources()
 *
