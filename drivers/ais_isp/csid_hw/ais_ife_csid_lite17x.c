...
#include "ais_ife_csid_lite_common_reg_v1.h"
...
static struct ais_ife_csid_hw_info ais_ife_csid_lite780_hw_info = {
	.csid_reg = &ais_ife_csid_lite_780_reg_offset,
	.hw_dts_version = AIS_CSID_VERSION_V200,
};

static struct ais_ife_csid_ver2_hw_info ais_ife_csid_lite_common_reg_v1_hw_info = {
	.csid_reg = &ais_ife_csid_lite_common_reg_v1_reg_offset,
	.hw_dts_version = AIS_CSID_VERSION_V200,
};
...
static const struct of_device_id ais_ife_csid_lite_dt_match[] = {
	...
	},
	{
		...
		.data = &ais_ife_csid_lite780_hw_info,
	},
	{
		.compatible = "qcom,ais-csid-lite1080",
		.data = &ais_ife_csid_lite_common_reg_v1_hw_info,
	},
	{}
};
