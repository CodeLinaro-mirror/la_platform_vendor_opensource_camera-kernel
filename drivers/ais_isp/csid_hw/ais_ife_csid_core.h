...
#define CSID_PATH_ERROR_FIFO_OVERFLOW             BIT(19)
#define CSID_PATH_ERROR_CCIF_VIOLATION            BIT(29)

#define CSID_TOP_IRQ_STATUS_BUF_DONE              BIT(13)
...
struct ais_ife_csid_common_reg_offset {
	...
	uint32_t csid_buf_done_irq_status_addr;
	uint32_t csid_buf_done_irq_mask_addr;
	uint32_t csid_buf_done_irq_clear_addr;
