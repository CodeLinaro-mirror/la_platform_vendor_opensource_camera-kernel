...
#ifndef _AIS_TFE_CSID_SOC_H_
#define _AIS_TFE_CSID_SOC_H_
...
/**
 * ais_tfe_csid_init_soc_resources()
 *
 ...
 *
 */
int ais_tfe_csid_init_soc_resources(struct cam_hw_soc_info *soc_info,
 ...
 *
 */
int ais_tfe_csid_deinit_soc_resources(struct cam_hw_soc_info *soc_info);

/**
 * ais_tfe_csid_enable_soc_resources()
 *
 ...
 *
 */
int ais_tfe_csid_enable_soc_resources(struct cam_hw_soc_info  *soc_info,
	uint32_t clk_lvl);

/**
 * ais_tfe_csid_disable_soc_resources()
 *
 ...
 *
 */
int ais_tfe_csid_disable_soc_resources(struct cam_hw_soc_info *soc_info);

/**
 * ais_tfe_csid_enable_ife_force_clock()
 *
 ...
 *
 */
int ais_tfe_csid_enable_ife_force_clock_on(struct cam_hw_soc_info  *soc_info,
	uint32_t cpas_ife_base_offset);

/**
 * ais_tfe_csid_disable_ife_force_clock_on()
 *
 ...
 *
 */
int ais_tfe_csid_disable_ife_force_clock_on(struct cam_hw_soc_info *soc_info,
	uint32_t cpas_ife_base_offset);

/**
 * ais_tfe_csid_get_vote_level()
 *
 ...
 *
 */
uint32_t ais_tfe_csid_get_vote_level(struct cam_hw_soc_info *soc_info,
	uint64_t clock_rate);

#endif /* _AIS_TFE_CSID_SOC_H_ */
