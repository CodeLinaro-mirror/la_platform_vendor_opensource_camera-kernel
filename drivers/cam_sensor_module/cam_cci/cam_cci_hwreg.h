...
#define CCI_GPIO_Q0_RESET_RMSK                                        0x100001
#define CCI_GPIO_Q1_RESET_RMSK                                        0x200001
#define CCI_GPIO_Q2_RESET_RMSK                                        0x400001
#define CCI_GPIO_RESET_RMSK                                               0x14
...
#define CCI_QTMR0_F0V2_QTMR_V2_CNTPCT_LO                            0x00000008
#define CCI_QTMR0_F0V2_QTMR_V2_CNTPCT_HI                            0x0000000C
#define CCI_GPIO_Q0_EXEC_WORD_CNT_ADDR                              0x00000700
#define CCI_GPIO_Q0_CUR_WORD_CNT_ADDR                               0x00000704
#define CCI_GPIO_Q0_CUR_CMD_ADDR                                    0x00000708
#define CCI_GPIO_Q0_REPORT_STATUS_ADDR                              0x0000070C
#define CCI_GPIO_Q0_LOAD_DATA_ADDR                                  0x00000710
#define CCI_GPIO_STATUS_ADDR                                        0x00000030
#define CCI_IRQ_MASK_0_ADDR                                         0x00000c04
#define CCI_IRQ_MASK_0_RMSK                                         0x7fff7ff7
#define CCI_IRQ_MASK_1_ADDR                                         0x00000c10
#define CCI_IRQ_MASK_1_RMSK                                         0x38110FFF
...
#define CCI_IRQ_STATUS_1_GPIO_Q0_REPORT_BMSK                               0x1
#define CCI_IRQ_STATUS_1_GPIO_Q1_REPORT_BMSK                              0x10
#define CCI_IRQ_STATUS_1_GPIO_Q2_REPORT_BMSK                             0x100
#define CCI_IRQ_STATUS_1_GPIO_Q0_HALT_ACK_BMSK                       0x8000000
#define CCI_IRQ_STATUS_1_GPIO_Q1_HALT_ACK_BMSK                      0x10000000
#define CCI_IRQ_STATUS_1_GPIO_Q2_HALT_ACK_BMSK                      0x20000000
#define CCI_IRQ_STATUS_1_GPIO_Q0_ERROR_BMSK                                0xE
#define CCI_IRQ_STATUS_1_GPIO_Q1_ERROR_BMSK                               0xE0
#define CCI_IRQ_STATUS_1_GPIO_Q2_ERROR_BMSK                              0xE00
...
#define DEBUG_GPIO_QUEUE_REG_START                                       0x700
#define DEBUG_GPIO_QUEUE_REG_COUNT                                           6
#define DEBUG_INTR_REG_START                                             0xC00
#define DEBUG_INTR_REG_COUNT                                                 7

#define GPIO_QUEUE_START_OFFSET                                              4
