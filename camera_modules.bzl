...
def _define_module(target, variant, lunch_target=None):
    ...
    ddk_module(
        ...
        conditional_srcs = {
            ...
            "CONFIG_MSM_AIS": {
                True: [
                    "drivers/ais_isp/csid_hw/ais_ife_csid_core.c",
					"drivers/ais_isp/csid_hw/ais_ife_csid_core_ver2.c",
                    "drivers/ais_isp/csid_hw/ais_ife_csid_dev.c",
                    "drivers/ais_isp/csid_hw/ais_ife_csid_soc.c",
                    "drivers/ais_isp/csid_hw/ais_ife_csid17x.c",
                    "drivers/ais_isp/csid_hw/ais_ife_csid_lite17x.c",
                    "drivers/ais_isp/vfe_hw/ais_vfe_core.c",
                    "drivers/ais_isp/vfe_hw/vfe17x/ais_vfe17x.c",
                    "drivers/ais_isp/vfe_hw/ais_vfe_soc.c",
                    "drivers/ais_isp/vfe_hw/ais_vfe_dev.c",
                    "drivers/ais_isp/ais_ife_dev.c",
                    "drivers/ais_isp/tfe_csid_hw/ais_tfe_csid.c",
                    "drivers/ais_isp/tfe_csid_hw/ais_tfe_csid_dev.c",
                    "drivers/ais_isp/tfe_csid_hw/ais_tfe_csid_core.c",
                    "drivers/ais_isp/tfe_csid_hw/ais_tfe_csid_soc.c",
                    "drivers/ais_isp/tfe_hw/ais_tfe_core.c",
                    "drivers/ais_isp/tfe_hw/tfe/ais_tfe.c",
                    "drivers/ais_isp/tfe_hw/ais_tfe_soc.c",
                    "drivers/ais_isp/tfe_hw/ais_tfe_dev.c",
                ],
            },
            "CONFIG_V4L2_LOOPBACK_V2": {
                True: [
                    "drivers/v4l2loopback-master_v2/v4l2loopback.c",
                ],
            },
        },
